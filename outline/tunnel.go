...
func NewTunnel(host string, port int, password, cipher string, isUDPEnabled bool, endpoint stack.LinkEndpoint) (Tunnel, error) {
	...
	t.Tunnel, err = tunnel.MakeTunnel(endpoint, tcp, udp)
	if err != nil {
		return nil, err
	}
	return t, nil
